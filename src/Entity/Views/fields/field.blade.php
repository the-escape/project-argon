...
{!! $html_open !!}
    ...
    @if($field instanceof \Escape\Argon\Entity\FieldTypes\TextFieldType)
    ...
    @elseif($field instanceof \Escape\Argon\Entity\FieldTypes\ImageFieldType)

        @include('argon::fields.type.image')

    @elseif($field instanceof \Escape\Argon\Entity\FieldTypes\FileFieldType)

        @include('argon::fields.type.file')

    @elseif($field instanceof \Escape\Argon\Entity\FieldTypes\BooleanFieldType)

        @include('argon::fields.type.boolean')

    @elseif($field instanceof \Escape\Argon\Entity\FieldTypes\ComboFieldType)

        @include('argon::fields.type.combo')

    @elseif($field instanceof \Escape\Argon\Entity\FieldTypes\SelectFieldType)

        @include('argon::fields.type.select')

    @elseif($field instanceof \Escape\Argon\Entity\FieldTypes\WysiwygFieldType)

        @include('argon::fields.type.wysiwyg')

    @elseif($field instanceof \Escape\Argon\Entity\FieldTypes\DatetimeFieldType)
    ...
    @elseif($field instanceof \Escape\Argon\Entity\FieldTypes\ItemFieldType)
