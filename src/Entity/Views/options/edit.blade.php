            ...
            <div class="card">
                ...
                <div class="card-block">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control required {{ Escape\Argon\Entity\Helpers\Validation::getErrorClass(@$errors, 'name') }}" id="name" name="name" placeholder="Name" value="{{ old('name', $option->name) }}">
                    </div>
                </div>
            </div>
