            ...
            <div class="card">
                ...
                <div class="card-block">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" class="form-control required {{ Escape\Argon\Entity\Helpers\Validation::getErrorClass(@$errors, 'name') }}" name="name" value="{{ old('name') }}">
                    </div>
                    <div class="form-group">
                        <label for="slug" class="required">URL Slug</label>
                        <input type="text" id="slug" class="form-control required slug {{ Escape\Argon\Entity\Helpers\Validation::getErrorClass(@$errors, 'slug') }}" name="slug" value="{{ old('slug') }}">
                    </div>
                    <div class="form-group">
