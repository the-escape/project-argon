...
@section('content')
    <div class="main">
        ...
        <form action="{{ route('cms:pages:update', [$page->getId(), $localeId]) }}" method="POST" id="pageEditForm">
            ...
            <button type="submit" class="btn btn-primary-outline save-revision" data-form-action="{{ route('cms:revisions:create', [$page->getId(), $localeId]) }}" onclick="this.disabled=true; this.textContent='Saving ...'; this.form.submit();">Save Revision</button>
