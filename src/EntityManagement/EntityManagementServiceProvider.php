...
use Escape\Argon\EntityManagement\FieldTypes\ButtonFieldType;
...
class EntityManagementServiceProvider extends AbstractPluginServiceProvider
{
    ...
    public function startup()
    {
        ...
        $this->pluginManager->registerNavLink('Content', route('cms:pages:manage'), 'cms:content:manage', 'sitemap');
...
//        $this->pluginManager->registerNavLink('Collections', route('cms:pages:manage'), 'cms:content:manage');
        $this->pluginManager->registerNavLink('Content Types', route('cms:types:manage'), 'cms:entity:type:manage', 'forms');
