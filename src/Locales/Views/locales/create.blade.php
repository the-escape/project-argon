                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="region_id" name="region_id" placeholder="Region">
                            @foreach($regions as $region)
                                <option value="{{ $region->id }}"{{ (old("region_id") == $region->id ? "selected":"") }}>{{ $region->region_name }} ({{ $region->display_name }})</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="region">Slug</label>
                        <input type="text" class="form-control" id="slug" name="locale_slug" placeholder="Slug" value="{{ old('locale_slug') }}">
                    </div>
                </div>
            </div>
