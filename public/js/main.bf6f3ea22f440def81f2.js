...
/* harmony default export */ var Mediavue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    onUpload: function onUpload() {
      ...
      Array.from(Array(this.selectedFiles.length).keys()).map(function (x) {
        fd.append('files[]', _this.selectedFiles[x], _this.selectedFiles[x].name);
      });
      this.$store.dispatch('uploadItems', fd);
    },
    onUpload2: function onUpload2() {
      ...
      console.log(payload); // this.$store.dispatch('uploadItems', payload)
    }
  }
});
