            ...
            _vm.search.hasKeywords()
              ...
              : [
                  ...
                  _c(
                    ...
                    [
                      _c("div", { staticClass: "folder__add" }, [
                        _c(
                          "button",
                          {
                            staticClass: "o-btn o-btn--xs",
...
/* harmony default export */ var store_store = (new vuex_esm["default"].Store({
  ...
  mutations: {
    ...
    folders: function folders(state) {
      getFoldersData(function (data) {
        ...
        getFolders(state.folder.id, function (f) {
          state.active = new folder_Folder(f.id, f.name, f.items, f.children, f.parent, true);
        });
      });
    },
    ...
    createFolder: function createFolder(state, parent) {
      addFolder('New Folder', parent.id, function (r) {
        if (r.status !== 200) {
          return alert(r.body.error);
        }

        var child = new folder_Folder(r.body.id, r.body.name, [], [], parent);
  ...
  actions: {
    ...
    createFolder: function createFolder(_ref7, parent) {
...
/******/ });
//# sourceMappingURL=main.852af45f4c093c792780.js.map