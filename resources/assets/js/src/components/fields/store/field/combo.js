...
export const comboMutations = {
    ...
    updateComboItemFieldValue (
        ...
        comboItemValues[fieldID].values = comboItemValues[fieldID].values.map(
            value => {
    ...
    addComboItemFieldValue (
        state,
        { groupID, fieldID, comboID, comboItemID, valueObj }
    ) {
        const combo = getCombo(
            state.groups[groupID],
            comboID,
    ...
    removeComboItemFieldValue (
        state,
        { groupID, fieldID, comboID, comboItemID, valueID }
    ) {
        const combo = getCombo(
            state.groups[groupID],
            comboID,
